...
export function PageTopBar({ title, notifBadgeCount = 0, onOpenNotifications, onOpenAccountMenu }: Props) {
  const { t } = useLanguage();
  return (
    <SafeAreaView edges={["top"]} style={styles.wrap}>
      <View style={styles.bar}>
        ...
        <View style={styles.actions}>
          ...
          <Pressable style={styles.iconBtn} onPress={onOpenAccountMenu} hitSlop={6}>
            <Svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke="#111827" strokeWidth={2}>
